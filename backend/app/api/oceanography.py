...
async def get_gdac_argo(bbox: str, start: date | None = None, end: date | None = None,
                        ...
                        limit: int = Query(3, ge=1, le=5), offset: int = Query(0, ge=0),
    ...
    return await get_profiles(parse_bbox(bbox), start, end, parameter, limit, pressure_min, pressure_max, offset)
